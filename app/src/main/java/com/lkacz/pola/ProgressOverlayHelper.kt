...
object ProgressOverlayHelper {
     ...
     */
    fun createOverlay(context: Context, button: Button): OverlayInfo {
        ...
        val overlayView = View(context).apply {
            ...
            layoutParams = FrameLayout.LayoutParams(0, button.height).also { lp ->
     ...
     */
    fun resetOverlay(overlayView: View, animator: android.animation.ValueAnimator) {
